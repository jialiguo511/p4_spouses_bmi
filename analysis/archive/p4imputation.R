...
library(mice)    # For compatibility with existing code
...
carrs_df <- readRDS("test/carrs_data.RDS") %>%
...
## ==== 8. Run Imputation with GPU Acceleration ================================
# CARRS 1
...
saveRDS(imp_carrs1, "test/psban_carrs1_mi_dfs.RDS")

# Clear GPU memory after first imputation
gc(); micemd::clear_gpu_memory()
...
saveRDS(imp_carrs2, "test/psban_carrs2_mi_dfs.RDS")
