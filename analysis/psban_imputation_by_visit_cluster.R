...
datasets_to_impute <- list(
  "carrs1_bs"   = "before_imputation/psbpre05_carrs1_bs.RDS",
  "carrs1_fup2" = "before_imputation/psbpre05_carrs1_fup2.RDS",
  "carrs1_fup4" = "before_imputation/psbpre05_carrs1_fup4.RDS",
  "carrs1_fup7" = "before_imputation/psbpre05_carrs1_fup7.RDS",
  "carrs2_bs"   = "before_imputation/psbpre05_carrs2_bs.RDS",
  "carrs2_fup2" = "before_imputation/psbpre05_carrs2_fup2.RDS"
)
...
perform_imputation <- function(dataset_name, file_path) {
  ...
  output_path <- paste0("imputed/", dataset_name, "_mi_dfs.RDS")
...
if(length(imputed_results) > 0) {
  ...
  write.csv(summary_df, 
            "imputed/imputation_summary.csv",
            row.names = FALSE)
